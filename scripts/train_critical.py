...
DATA_PATH = "data/critical_train.json"
OUTPUT_DIR = "./adapters/critical_lora"
...
if len(raw_dataset) == 0:
    raise RuntimeError("训练数据为空，请检查 data/critical_train.json")
...
print("✅ Critical Agent LoRA 训练完成！")
