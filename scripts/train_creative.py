...
DATA_PATH = "data/creative_train.json"
OUTPUT_DIR = "./adapters/creative_lora"
...
if len(raw_dataset) == 0:
    raise RuntimeError("训练数据为空，请检查 data/creative_train.json")
...
print("✅ Creative Agent LoRA 训练完成！")
