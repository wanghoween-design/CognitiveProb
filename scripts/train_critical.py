...
lora_config_dict = config["model"]["lora"]["critical"]
...
# ==================== 加载训练数据 ====================
print("加载训练数据...")
dataset = load_dataset("json", data_files="data/critical_train.json", split="train")
...
training_args = TrainingArguments(
    output_dir="./adapters/critical_lora",    # 训练结果保存到这里
    num_train_epochs=4,                       # 训练 4 轮（避免最后 epoch 的梯度跳升）
...
# ==================== 开始训练 ====================
print("开始训练 Critical Agent LoRA...")
...
print(f"✅ Critical Agent LoRA 训练完成！")
