"""
Critical LoRA 训练指标可视化：论文风格 2D 多指标图
用法: python scripts/plot_critical.py
...
# ==================== 基础配置 ====================
LOG_PATH = Path(__file__).parent.parent / "adapters" / "critical_lora" / "training_log.json"
...
# ==================== 总标题与说明 ====================
fig.suptitle(
    "Critical LoRA Training Metrics",
    fontsize=15,
    fontweight="bold",
    y=0.98,
)
