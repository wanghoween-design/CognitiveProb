"""
Forward LoRA 训练指标可视化：论文风格 2D 多指标图
用法: python scripts/plot_forward.py
...
# ==================== 基础配置 ====================
LOG_PATH = Path(__file__).parent.parent / "adapters" / "forward_lora" / "training_log.json"
